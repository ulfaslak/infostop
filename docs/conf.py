...
latex_documents = [
    (master_doc, "infostop.tex", "infostop Documentation", "Ulf Aslak", "manual"),
]
...
man_pages = [(master_doc, "infostop", "infostop Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        __author__,
        "Stop location detection using Infomap, in Python",
        "Miscellaneous",
    ),
]
