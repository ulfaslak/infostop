...
project = u'infostop'
copyright = u'2019, Ulf Aslak'
author = u'Ulf Aslak, Laura Alessandretti'
...
latex_documents = [
    (master_doc, 'infostop.tex', u'infostop Documentation',
     u'Ulf Aslak', 'manual'),
]
...
man_pages = [
    (master_doc, 'infostop', u'infostop Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'infostop', u'infostop Documentation',
     author, __author__, 'Stop location detection using Infomap, in Python',
     'Miscellaneous'),
]
